...
class IdentificationType(Base):
    ...
    identification_type_name: Mapped[str] = mapped_column(String(255), nullable=False)
    identification_type_description: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)